    ...
    <div class="container mx-auto">
      ...
      <div class="bg-white shadow overflow-hidden rounded-md">
        ...
        <div class="border-t border-gray-200">
          @if ($errors->any())
            <div class="alert-danger mb-4 mx-4 mt-4">
          ...
          <form action="{{ route('users.store') }}" method="POST" class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6 sm:col-span-3">
                ...
                <input type="text" name="username" id="username" class="form-control mt-1 block w-full h-8 shadow-sm sm:text-sm rounded-md" required>
              </div>
              <div class="col-span-6 sm:col-span-3">
                <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                <input type="password" name="password" id="password" class="form-control mt-1 block w-full h-8 shadow-sm sm:text-sm rounded-md" required>
              </div>
              <div class="col-span-6 sm:col-span-3">
                <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Konfirmasi Password</label>
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control mt-1 block w-full h-8 shadow-sm sm:text-sm rounded-md" required>
              </div>
              <div class="col-span-6 sm:col-span-3">
                <label for="jabatan" class="block text-sm font-medium text-gray-700">Jabatan</label>
                <input type="text" name="jabatan" id="jabatan" class="form-control mt-1 block w-full h-8 shadow-sm sm:text-sm rounded-md" required>
              </div>
              <div class="col-span-6 sm:col-span-3">
                <label for="jeniskelamin" class="block text-sm font-medium text-gray-700">Jenis Kelamin</label>
                <select name="jeniskelamin" id="jeniskelamin" class="form-control mt-1 w-full h-8 rounded-md shadow-sm" required>
            ...
            <div class="mt-6">
              <button type="submit" class="w-[95px] h-8 rounded-xl bg-green-500 hover:bg-green-600 duration-200 text-white font-bold">Simpan</button>
            </div>
          </form>
        </div>
      </div>

      <!-- Tabel Data Karyawan (Responsive) -->
      <div class="mt-8">
                  ...
                  <tr>
                    ...
                    <td class="table-cell">
                      <div class="flex space-x-2">
                        <a href="{{ route('users.edit', $user->id) }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded text-xs">Edit</a>
